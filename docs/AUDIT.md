...
> **Status note, added after E1.** This document records the repository as it was at the E0
> audit, and its per-file verdicts describe that state. E1 has since been completed (every
> task except E1.20, which is blocked on maintainer approval), so many REFACTOR and REPLACE
> verdicts below have been acted on. It is kept as the historical record the E0.5
> reconciliation was made against, not as a description of the current tree; for that, read
